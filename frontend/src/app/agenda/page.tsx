...
export default function Page() {
  ...
  const canCreate = useHasPermission('Agenda-Create')
  const canDelete = useHasPermission('Agenda-Delete')
  const canEdit = useHasPermission('Agenda-Edit')
  ...
  return (
    <ProtectedRoute>
      <PermissionRoute requiredPermissions={['Agenda-View']}>      
        <Layout>
                        ...
                        <div key={ev.id} className="px-4 py-4 sm:px-6">
                          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            <div className="flex items-center gap-2 sm:flex-shrink-0">
                              ...
                              >
                                {canEdit && <Pencil className="h-3.5 w-3.5" />}
                              </Button>
                              <Button
                                variant="destructive"
                                size="sm"
                                ...
                                className="flex items-center gap-1.5 px-3 py-1.5 cursor-pointer"
                              >
                                {canDelete && <Trash2 className="h-3.5 w-3.5" />}
                              </Button>
                            </div>
                          </div>
                        </div>
