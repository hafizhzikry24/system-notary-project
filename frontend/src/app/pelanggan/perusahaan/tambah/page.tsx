...
// ------------------- Component -------------------
export default function CreateCustomerCompany() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await api.post("/customer-companies", formDataToSend, {
        headers: { "Content-Type": "multipart/form-data" },
      });

      showSuccess("Customer perusahaan created successfully!");
      router.push("/pelanggan/perusahaan");
    } catch (error: any) {
      if (error.response?.status === 422) {
        showValidationErrors(error.response.data.errors);
      } else {
        showError("Failed to create customer Perusahaan!");
      }
    } finally {
      setSaving(false);
    }
  ...
  return (
    <ProtectedRoute>
      <PermissionRoute requiredPermissions={['Pelanggan-Perusahaan-Create']}>              
        <Layout>
          <div className="container mx-auto px-16 py-8">
            <h1 className="text-2xl font-bold mb-6">Create Customer Perusahaan</h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <LabelInputContainer>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleInputChange("deed_number", e.target.value)}
